...
| M4 Heat Inserts*   | 6.3mm OD                 | 12   | Aliexpress<br>[Amazon.de](https://amzn.to/4wZr2uZ) | A heat insert with 6mm OD will also work.<br><br>*Only required when printing the heat insert version. |
