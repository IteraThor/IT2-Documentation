...
>
> ---
> *Hinweis: Da ich dieses Projekt als Einzel-Designer leite, nutze ich KI-Unterstützung für die umfangreiche Dokumentation. Es kann sein, dass manche Abschnitte aufgrund von KI-Fehlern unklar sind. Bis ich Zeit für eine vollständige Prüfung habe, seid bitte aufmerksam und meldet Unklarheiten direkt im Discord.*

Die **IT2 Baseplate** ist eine Montagelösung für das IT2 Autodarts-System. Sie wurde entwickelt, um die Installation zu vereinfachen, die Wände zu schützen und bietet erweiterte Funktionen wie Schalldämmung und native Kompatibilität mit Dartboard-Ständern.

![baseplate_cover](images/05_baseplate/00_baseplate_cover.png)

> 📥 **Dateien herunterladen:** [IT2 Baseplate auf Makerworld](https://makerworld.com/en/models/2782096)
...
## 1. Allgemeine Übersicht: Die IT2 Baseplate

Obwohl das IT2-System direkt an der Wand montiert werden kann, bietet die Baseplate mehrere entscheidende Vorteile:
*   **Strukturelle Steifigkeit:** Das 4-teilige Design bietet im Vergleich zu 7-teiligen Alternativen eine überlegene Stabilität. Diese erhöhte Steifigkeit minimiert das Verbiegen und stellt sicher, dass deine Kameraarme in ihrer exakten Position bleiben.
*   **Minimales Bohren:** Es werden nur 3 Löcher in der Wand benötigt statt 6 oder mehr.
*   **Perfekte Ausrichtung:** Die Baseplate stellt sicher, dass deine Kameraarme perfekt zentriert und nivelliert zum Bullseye ausgerichtet sind.
*   **Schalldämmung:** Integrierte kreisförmige Gewinde-Aussparungen für spezielle TPU-Dämpfer zur Reduzierung der Schallübertragung.
*   **Ständer-Kompatibilität:** Native Kompatibilität mit dem **Winmau Xtreme 2** Dartboard-Ständer, standardmäßig und ohne Modifikationen.
...
> 💡 **Wichtig:** Obwohl eine "Self-Tapping"-Version der Baseplate verfügbar ist, gilt dies nur für die M4-Befestigungspunkte. Die **M6 Schmelzeinsätze** für die Rota Locks sind für alle Versionen **immer Pflicht**, da diese Teile häufig justiert werden und die Haltbarkeit eines Metallgewindes benötigen.

Wenn du die **Schmelzeinsatz-Version** nutzt, schmelze die M4-Einsätze in die vorgesehenen Löcher an den Enden der drei Montagearme ein.
...
> 💡 **M4 Schmelzeinsatz-Guide für Dartboard-Montage:**
> Standard-Wandmontage: Nutze **2 Einsätze wie auf dem Foto gezeigt**.
> Mobiler Ständer oder niedrige Decke: Nutze die **anderen zwei ungenutzten Löcher** (oder alle vier) pro Arm.
> Addons: Zusätzliche Einsätze können für [Addons](#5-pro-tipps-erweiterte-funktionen--addons) erforderlich sein.

> 
> ⚠️ **Ausrichtung:** Die Fotos zeigen die **Standard-Ausrichtung**. Wenn du für einen Dartständer oder eine niedrige Decke baust, stelle sicher, dass du die Arme korrekt ausrichtest (unter Nutzung der alternativen Befestigungslöcher).

### 3.2 Schritt 2: Verbinden der Segmente
Die drei Montagearme werden über eine einfache **Face-to-Face Schraubverbindung** mit dem Mittelstück verbunden.
...
2. Richte die Beine der Kameraarme an den Befestigungspunkten der Baseplate-Arme aus.
3. Befestige das System mit **drei M4-Schrauben**.

---

## 4. Letzter Schritt: Installation & Montage
...
3.  **Stütze (Optional):** Wenn sich dein Setup kopflastig anfühlt, empfehlen wir die Nutzung der zusätzlichen Stütz-Addons aus dem Druckprofil (erfordert 2 zusätzliche M6 Schmelzeinsätze).

---

## 5. Pro-Tipps: Erweiterte Funktionen & Addons

Das IT2 Baseplate-System unterstützt mehrere modulare Addons zur Funktionserweiterung:
...
1.  **Vorbereitung der Baseplate:** Nutze einen Schraubendreher und einen Hammer (oder ein ähnliches Werkzeug), um die vorperforierten Sollbruchstellen in der Mitte der Aussparungen herauszuschlagen.
2.  **Dämpfer einsetzen:** Schraube die 3D-gedruckten TPU-Dämpfer in die Gewinde-Aussparungen.
3.  **Montage:** Nutze die Löcher in der Mitte der TPU-Dämpfer, um die gesamte Einheit an der Wand zu befestigen.

> ⚠️ **Wichtig:** Ziehe die Schrauben nicht zu fest an. Das TPU sollte sicher gehalten, aber nicht gequetscht oder übermäßig komprimiert werden, da dies den Dämpfungseffekt aufheben würde.

### 5.2 RGB-Ring-Erweiterung & Kamera-Blende (In Arbeit)
...
*   **Integrierte Raspberry Pi Halterung:** Native Unterstützung zur Montage eines Raspberry Pi direkt an der Baseplate für eine vollkommen autarke Scoring-Einheit.
*   **Erweiterte Ständer-Unterstützung:** Wir prüfen derzeit die Unterstützung für weitere Dartständer (z.B. KOTO oder Budget-Alternativen) für zukünftige Updates.

---

[Zurück zur Hauptanleitung](README.de.md)
