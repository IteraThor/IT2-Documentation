...
| Cilinderkopschroef | M2 (ISO4762/DIN912)      | 6-12   | [Aliexpress](https://s.click.aliexpress.com/e/_c4WUfT79)<br>[Amazon.de](https://amzn.to/4u4l5du) | Cameraschroeven.                                                                                       |
| M4 Smeltmoeren*    | 6.3mm OD (max 9mm lang)  | 12     | Aliexpress<br>[Amazon.de](https://amzn.to/4wZr2uZ) | Een smeltmoer met 6mm OD werkt ook.<br><br>*Alleen vereist bij het printen van de "heat insert" versie. |

### 2.2 Benodigd Gereedschap

| Gereedschap           | Doel                                                                    |
| --------------------- | ----------------------------------------------------------------------- |
| Inbussleutelset       | Voor M4 en M2 cilinderkopschroeven.                                     |
| Tang / Zijkniptang    | Nodig voor het verkleinen van de cameraframes van 38x38 naar 32x32.      |
| Soldeerbout           | Nodig voor het smelten van de M4 smeltmoeren (alleen Heat Insert versie).|
...
*   **Keerzijde:**
    *   **Afstand tot de muur:** De baseplate voegt ongeveer **30mm diepte** toe. Je **MOET** je oche (werplijn) afstand met 30mm aanpassen om de officiële afmetingen te behouden.
...
| ------------- | -------------------------------------- | ---------- | ----------------------------------------------- |
| Camera's      | HBV OV2710                             | Aliexpress | Camera's met de beste prijs-kwaliteitverhouding.|
| LED-strip     | Auxmer 12V 9.6W LED-strip              | Aliexpress | Persoonlijke favoriet. Meest natuurgetrouwe kleuren. |
